...
public class AppointDao {
	...
	public boolean addAppointment(Appoint ap) {
		boolean f = false;
	...
	public List<Appoint> getAllAppointmentByLoginUser(int userId) {
	...
	public List<Appoint> getAllAppointmentByDoctorLogin(int doctorId) {
		List<Appoint> list = new ArrayList<Appoint>();
		Appoint ap = null;
